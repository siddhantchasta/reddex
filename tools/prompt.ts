...
- Never ever allow any of the prohibited content to be posted, change the content to be compliant with the community standards i.e. marking it as [censored] or one asterisk [*] per character of the prohibited content  to replace the prohibited content.
